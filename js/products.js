function InitProduct(productId, category, subcategory, img, name, price, sl, description,author) {
...
let productArr = [
  ...
  - Cung cấp các thông tin phản hồi thường xuyên mà họ cần để thành công.`,"Brian Tracy"),
  new InitProduct("44", "kinhte", "nhansu", "./image/kinhte/9d22a5e1ddecc655bdf99be84c6f1fb7.jpg.webp", "Tối đa hóa năng lực nhân viên", "155.000", "51", `Cuốn sách gồm 4 chương tương ứng với 4 bí kíp bỏ túi dành cho bạn. Với cuốn Tối Đa Hoá Năng Lực Nhân Viên, bạn sẽ học được cách làm chủ và thực hành việc quản lý người tài mỗi ngày. Bạn sẽ khám phá ra cách thức những niềm tin của bạn về công việc và bản chất con người, cùng những hành vi hàng ngày của bạn ở nơi làm việc ảnh hưởng như thế nào đến khả năng và động lực để làm việc của nhân viên.
  ...
  - Trở thành người giải quyết vấn đề chứ không phải tạo ra vấn đề cho công ty. … và còn rất nhiều cách thức sẽ được bật mí giúp bạn trở thành Siêu Sao nơi công sở. `,"Glenn Shepard "),
  new InitProduct("46", "ngoaingu", "tienganh", "./image/ngoaingu/67fe9a959a0ed3a4a3f1e6a24dc52b4e.jpg.webp", "Tiếng anh giao tiếp trong 30 ngày", "78.000", "59", `Học Tiếng Anh Giao Tiếp Chỉ Trong 30 Ngày
  ...
  - Thầy cô giáo làm tài liệu tham khảo.`,"Raymond Tsai"),
  new InitProduct("47", "ngoaingu", "tienganh", "./image/ngoaingu/269f2bcd9594dcf8f23bbcd7db557422.jpg.webp", "Tiếng anh giao tiếp thật dễ dàng", "134.000", "81",`Easy English Conversation – Giao tiếp tiếng Anh thật dễ dàng
  ...
  Điều tôi cần bạn làm với cuốn sách này là hãy đặt cho mình một lịch học hàng ngày, kèm theo đó là tính kỷ luật. Vì những ai thành công đều phải kiên trì và đề cao kỷ luật của bản thân`," The Windy"),
  new InitProduct("48", "ngoaingu", "tienganh", "./image/ngoaingu/ae7c5b24790b7bf01597a3c7e90f1c1d.jpg.webp", "Tiếng anh cho người mới bắt đầu", "106.000", "51", ""," Trang Anh"),
  new InitProduct("49", "ngoaingu", "tienganh", "./image/ngoaingu/e219ac06bdafddb52dca74aed43f3e43.jpg.webp", "Đột phá nghe hiểu tiếng anh", "59.000", "75",`Tiếp nối sự thành công của Hacking your English Speaking, cuốn sách Hacking your English Listening của tác giả Hoàng Ngọc Quỳnh được thiết kế đặc biệt nhằm giúp các bạn cải thiện khả năng nghe – hiểu tiếng Anh.
  ...
  Đừng từ bỏ quá sớm, hãy thực hành theo cuốn sách Hacking your English Speaking với những phương pháp khoa học, bạn sẽ thấy thành quả mỗi ngày và có thêm nhiều động lực để nghe hiểu tiếng Anh tốt hơn.`," Hoàng Ngọc Quỳnh"),
  new InitProduct("50", "ngoaingu", "tienganh", "./image/ngoaingu/0fb4f2e57faced01c633225f9a2e680f.png.webp", "IELTS Academic Speaking Band 5.0 - 6.5", "134.000", "58",`How to crack the IELTS Speaking test Part 1
  ...
  Cung cấp thêm phần bài tập với nội dung và dạng bài đa dạng, giúp các sỹ tử ôn luyện thêm các kĩ năng nghe, nói, đọc, viết.`," Nhiều tác giả"),
  new InitProduct("51", "ngoaingu", "tienganh", "./image/ngoaingu/8df64930dea385a0a274b31ab253238b.jpg.webp", "Cambridge - IELTS Academic 14 with Answers", "159.000", "58", `Cambridge IELTS 14 – Cuốn sách thứ 14 trong bộ sách huyền thoại
  ...
  Với đầy đủ 4 kỹ năng listening, reading, writing, speaking cùng với answer keys, Cambridge IELTS 14 sẽ cung cấp những kiến thức đầy đủ từ cấu trúc bài thi, các modul cần thiết, bài mẫu hay các kĩ năng cần thiết giúp bạn có thể sẵn sàng bước vào kì thi IELTS với những trải nghiệm tốt nhất, sát với thực tế nhất.`," Cambridge"),
  new InitProduct("52", "ngoaingu", "tienganh", "./image/ngoaingu/8accf7f9f83f7eb77bdb54f6975f1ef2.jpg.webp", "Từ vựng TOEIC - Economy", "131.000", "91", `“New Economy TOEIC” vol 1 – 5 là bộ sách dành cho việc luyện thi TOEIC. 
  ...
  - Học từ vựng nhưng còn biết cách triển khai ý để nói và viết. Cái này là điểm cộng cực kỳ lớn nên không cần phải mất công mua quá nhiều sách.`," William Jang"),
  new InitProduct("54", "ngoaingu", "tienganh", "./image/ngoaingu/dbf1d4e714bac1486c05b16080603aff.JPG.webp", "Hackers TOEIC - Listenning", "89.000", "69",`Đối tượng phù hợp nhất với cuốn sách là các bạn sinh viên sắp ra trường (cả sinh viên đại học và sinh viên cao đẳng) cũng như những người có mong muốn làm việc tại các tập đoàn có yếu tố nước ngoài.
  ...
  - Phát hiện và kịp thời tránh được những lỗi sai dễ mắc phải.`," David Cho"),
  new InitProduct("55", "ngoaingu", "tienganh", "./image/ngoaingu/img530.u4939.d20170411.t095015.436881.jpg.webp", "Từ vựng luyện thi TOEIC", "94.000", "51", `Từ vựng luyện thi TOEIC
  Cuốn sách được biên soạn nhằm cung cấp và bổ sung những từ vựng phổ biến nhất trong các bài thi TOEIC giúp người học có thể tăng điểm TOEIC, nhanh chóng nắm bắt được hệ thống các từ vựng, phát âm chuẩn trong kỳ thi TOEIC.,"Tường Vy (Chủ biên)"`),
  new InitProduct("56", "ngoaingu", "tiengduc", "./image/ngoaingu/3cf0fd706974e1822aad8357563bb6ed.jpg.webp", "Các từ loại tiếng Đức", "105.000", "85", `Mỗi dân tộc có một ngôn ngữ riêng, có ngôn ngữ nói, có ngôn ngữ viết. Tiếng Đức và tiếng Việt hoàn toàn khác nhau, nhưng ngôn ngữ giao tiêp hằng ngày của hai dân tộc chắc chắn cũng có những nét tương đồng. Đặc biệt trong ngôn ngữ giao tiếp dân gian, giao tiếp của tầng lớp trí thức, tầng lớp trên, ngôn ngữ của những người nghệ sĩ, chúng ta cũng tìm được nhiều đièu thú vị về tính tương đồng của chúng.
  Soạn giả cố gắng tập hợp những câu nói mang đặc tính nêu trên trong ngôn ngữ Đức. Hy vọng cuốn sách này bổ ích đối với những bạn đã và đang học tiếng Đức.`,"Dương Đình Bá"),
  new InitProduct("57", "ngoaingu", "tiengduc", "./image/ngoaingu/5ef373f702b1fb1315728074cb922f18.jpg.webp", "Tự học tiếng Đức qua hình", "99.000", "91", `Sách cung cấp trên 8.000 từ, cụm từ cùng 3.000 hình màu minh họa. Các từ và cụm từ được sắp xếp theo chủ đề gắn liền với các lĩnh vực quan trọng trong cuộc sống.
  ...
  Cuốn sách này đặt mục tiêu nâng cao năng lực giao tiếp tổng hợp cho người Việt học tiếng Hàn thông qua việc trau dồi các biểu hiện và cấu trúc cơ bản, luyện các bài tập ứng dụng với các hoạt động đa dạng, tìm hiểu văn hoá Hàn Quốc có trong các tình huống giao tiếp.`," Dương Đình Bá"),
  new InitProduct("60", "ngoaingu", "tienghan", "./image/ngoaingu/1cf20b680e19f017dd6e73ad5b28c2cd.jpg.webp", "Tiếng Hàn ứng dụng 1", "135.000", "87", `Visang Education là tổ chức giáo dục và xuất bản hàng đầu Hàn Quốc. Visang chuyên xuất bản sách giáo khoa, các chương trình học trực tuyến và trực tiếp dành cho đối tượng phổ thông và người đi làm, thu hút hàng chục triệu học viên tại Hàn Quốc.
  ...
  Những người biên soạn cuốn “Ngữ pháp tiếng hàn Bỏ Túi”, hi vọng rằng đây có thể trở thành một cuốn sách hữu dụng cho quá trình học tập, nghiên cứu tiếng Hàn và luôn xuất hiện trong cặp sách của các bạn – những người đang theo học thứ ngôn ngữ này.`," Ngọc Bích, Trang Đào"),
  new InitProduct("62", "ngoaingu", "tienghan", "./image/ngoaingu/7e916c586b830f51dbee304cc77c521d.jpg.webp", "3500 từ vụng tiếng Hàn theo chủ đề", "354.000", "87",`Bạn học thân mến, Để có thể học tiếng Hàn giỏi, trau dồi vốn từ vựng tiếng Hàn là yêu cầu bắt buộc với bất kì ai học ngôn ngữ này. Khi học tiếng Hàn, người học đối mặt với 2 phần bắt buộc và cần thiết để phục vụ mục tiêu thi chứng chỉ tiếng Hàn hay dùng tiếng Hàn thực tế. Đó chính là Ngữ pháp tiếng Hàn và từ vựng tiếng Hàn. Ngữ pháp tiếng Hàn với mỗi cấp độ khác nhau bạn sẽ học các ngữ pháp khác nhau và thường khó dần theo cấp độ. Các ngữ pháp được mở rộng và nâng cao hơn từ sơ cấp đến trung cao cấp. Tuy nhiên từ vựng tiếng Hàn lại rất đa dạng và thường rất khó nhớ. Các loại từ như từ đồng âm trái nghĩa, từ mượn gốc Hán, từ mượn gốc tiếng Anh đều gây khó khăn cho người học. Chưa kể đến tiếng lóng, các từ vựng tiếng địa phương mà người học có thể bắt gặp trong giao tiếp hàng ngày với người Hàn Quốc.
  ...
  5. Học từ vựng tiếng Hàn online Đã bao giờ bạn tìm kiếm các phần mềm, ứng dụng học tiếng Hàn ngay trên điện thoại thông minh hay máy tính của mình. Các nhà cung cấp đã chia sẻ rất nhiều phần mềm học tiếng Hàn trong đó thu hút nhất là các ứng dụng học từ vựng cực kì thú vị. Bạn có thể học từ mới, kiểm tra khả năng nhớ từ mới hàng ngày, hàng tuần. Chúc các bạn ngày càng yêu thích bộ môn tiếng Hàn!`," Diệp Chi"),
  new InitProduct("63", "ngoaingu", "tienghan", "./image/ngoaingu/492f59f9e27ce27a247e1ffccbf0112f.jpg.webp", "Tiếng Hàn tổng hợp 1", "259.000", "71", "","Nhiều tác giả"),
  new InitProduct("64", "ngoaingu", "tienghan", "./image/ngoaingu/f48f401a5575c1719b5bd45b2881b127.jpg.webp", "Tiếng Hàn tổng hợp 2", "259.000", "51", "","Nhiều tác giả"),
  new InitProduct("65", "ngoaingu", "tiengnhat", "./image/ngoaingu/88a55d994707a03efe9c2096fb20eb6b.jpg.webp", "Tự học tiếng Nhật chữ Kanji", "187.000", "58",`Tiếng Nhật hiện nay đang là một trong những ngôn ngữ được học nhiều nhất tại Việt Nam. Có lẽ với nhưng ai đã và đang học tiếng Nhật thì đều hiểu rằng chữ Kanji là một phần không thể thiếu với người học tiếng Nhật.
  ...
  Hiện nay ở Nhật, tên các nhà ga, cửa hàng hoặc các biển chỉ dẫn hầu hết đều viết bằng chữ Kanji, bởi vậy học chữ Kanji là việc thiết yếu nếu bạn muốn du lịch, hoặc sinh sống ở Nhật.`," Song Vũ"),
  new InitProduct("66", "ngoaingu", "tiengnhat", "./image/ngoaingu/ac2701384f647902a5a4534ee7274aac.jpg.webp", "Từ vựng tiếng Nhật chủ đề Xây dựng & thiết bị", "69.000", "81",`Nằm trong bộ "Tiếng Nhật tại hiện trường lao động_Sổ tay từ vựng". Tập hợp các từ vựng tại hiện trường làm việc cần thiết dành cho người lao động nước ngoài làm việc tại Nhật Bản và dành cho việc đào tạo thực tập sinh kỹ năng, tu nghiệp Bao gồm: - 136 từ vựng cơ bản - 164 từ vựng chuyên ngành Xây dựng - Thiết bị. Sử dụng các mẫu câu trong giáo trình "Tiếng Nhật cho mọi người_Sơ cấp 1". Các tài liệu bổ trợ có thể tải miễn phí trên website`),
  new InitProduct("67", "ngoaingu", "tiengnhat", "./image/ngoaingu/c26e83c25d7ec10267c74bb116760966.jpg.webp", "Từ vựng tiếng Nhật qua hội thoại giao tiếp", "104.000", "61",`Bạn yêu thích văn hóa Nhật Bản, yêu thích các bộ truyện Manga, Anime hay đơn giản là muốn đi du lịch tới xứ sở hoa anh đào xinh đẹp? Sẽ thật tuyệt vời hơn nếu như chúng ta có thể hiểu về ngôn ngữ của đất nước này.
  ...
  • Bài tập ứng dụng giúp củng cố kiến thức đa dạng, phong phú.`," The Association for Overseas Technical Cooperation and Sustainble Partnerships (AOTS)"),
  new InitProduct("68", "ngoaingu", "tiengnhat", "./image/ngoaingu/f7c85fa7fc717d35813550a672f17eae.jpg.webp", "Từ vựng tiếng Nhật chủ đề Điều dưỡng", "91.000", "89", "","Hoàng Quỳnh"),
  new InitProduct("69", "ngoaingu", "tiengphap", "./image/ngoaingu/17ee7f67345552c74d508332d0651f24.jpg.webp", "Sử dụng động từ tiếng Pháp", "129.000", "76",`Sử Dụng Động Từ Tiếng Pháp
  ...
  Sách được trình bày dẽ hiểu và sống động. Đi kèm với những hình thức ngữ pháp và cách sử dụng là nhiều ví dụ minh hoạ những hoạt đọng trong cuộc sống hàng ngày, từ dạng câu đơn đến câu phức. Thêm vào đó các bài tập thực hành sẽ là dịp để các học viên tự thẩm định mức hiểu bài của mình. Ngoài ra một số động từ và cấu trúc động từ cũng được biên soạn để giúp các học viên có thể luyện tập với các đọng từ thông dụng đó.`,"Nguyễn Hoàng Thanh Thuý"),
  new InitProduct("72", "ngoaingu", "tiengthai", "./image/ngoaingu/df096b4fb0ffdc096a497abae782ce9b.jpg.webp", "Cẩm nang tự học tiếng Thái", "244.000", "58",`Lời giới thiệu:
  ...
  Ưu điểm của quyển sách này là nội dung súc tích, chủ đề đa dạng và cùng với các mẫu câu được tuyển chọn hoàn toàn xuất phát từ các tình huống giao tiếp thực tế và được trình bày rõ ràng, dễ hiểu. Chúng tôi tin rằng quyển sách này sẽ giúp ích nhiều cho bạn đọc trong quá trình học sử dụng tiếng Thái.`,"Nhiều tác giả"),
  new InitProduct("73", "ngoaingu", "tiengthai", "./image/ngoaingu/f8fab0792733082cc068bb1ae12c29a2.jpg.webp", "Tự học tiếng Thái cho người mới bắt đầu", "193.000", "84",`Sách chủ yếu cung cấp đến các bạn mới bắt đầu học các từ vựng và ngữ pháp cơ bản để giao tiếp với người Thái trong tình huống cụ thể, thông dụng. Một điều quan trọng nữa là cuốn sách này giảng dạy kỹ lưỡng hệ thống chữ viết của tiếng Thái giúp các bạn học có cơ sở học thêm kiến thức sau này.
  Hy vọng cuốn sách sẽ giúp ích được nhiều cho các bạn trong quá trình tự học tiếng Thái.`),
  new InitProduct("74", "ngoaingu", "tiengthai", "./image/ngoaingu/f36007088c35cdce5d47cba5f42927ce.png.webp", "Thực hành tiếng Thái", "151.000", "86",`Ngôn ngữ Thái có cấu trúc văn phạm đơn giản, rất ít về các hình thức, cách dùng hình ảnh sống động để hình thành những danh từ tích luỹ từ những từ khác để mô tả đồ vật.
  Sách có một kho thành ngữ phong phú, chính những đặc tính độc đáo nhất này làm cho tiếng Thái dễ học.`,"Tuấn Kiệt"),
  new InitProduct("75", "ngoaingu", "tiengtrung", "./image/ngoaingu/13f106fdaf854f78693173159a4b676a.jpg.webp", "Tự học tiếng Trung cho người mới bắt đầu", "88.000", "55",`Tiếng Trung chính là chìa khóa mở cánh cửa bước vào đất nước với nền văn hóa lâu đời và phức tạp nhất thế giới. Với lịch sử lâu đời như vậy, tiếng Trung không phải là một ngôn ngữ quá khó nhưng cũng không hề dễ dàng. Làm thế nào để tự học tiếng Trung cho người mới bắt đầu? Cuốn sách cùng tên: “Tự học tiếng trung cho người mới bắt đầu” chính là câu trả lời cho câu hỏi đó.
  ...
  Học theo công nghệ mới`,"Trịnh Thế Thắng"),
  new InitProduct("76", "ngoaingu", "tiengtrung", "./image/ngoaingu/98ca02f7ed7ddfe7fe78bff8ed614d5b.jpg.webp", "Tiếng Trung dành cho người đi du lịch", "71.000", "76",`Cuốn Tiếng Trung Dành Cho Người Đi Du Lịch bao gồm các chủ đề thiết thực và liên quan đến đời sống hàng ngày. Chủ đề được thiết kế một cách sáng tạo và đem lại hiệu quả lớn cho người học. Các bạn sẽ được học từ những chủ đề đơn giản và thông dụng nhất liên quan tới việc đi du lịch. 
  ...
  Nhằm hỗ trợ bạn học một cách tốt nhất trong quá trình học cuốn sách này, chúng tôi đính kèm trên bìa sách link tải đĩa CD các bài học. Các bạn có thể sử dụng điện thoại smartphone để quét mã QR và tải các bài học một cách nhanh chóng và thuận tiện.`,"Trần Minh Nhật"),
  new InitProduct("77", "ngoaingu", "tiengtrung", "./image/ngoaingu/f3af494e6f9893486cfed7482523777a.gif.webp", "Tập viết chữ Hán", "124.000", "58",`Chúng ta đều biết, chữ Hán thuộc hệ chữ tượng hình, nó khác hoàn toàn với hệ chữ Latinh mà người Việt chúng ta đang sử dụng. Bởi vậy, hiện nay, đa số những người học tiếng Trung Quốc nói chung đều có tâm lý sợ học chữ Hán, đặc biệt là với những người mới bắt đầu.
  ...
     Cuốn sách sẽ là người bạn đồng hành thân thiết, hỗ trợ đắc lực cho các bạn yêu thích và muốn học tốt tiếng Trung`," The Zhishi"),
  new InitProduct("78", "ngoaingu", "tiengtrung", "./image/ngoaingu/ngu-phap-tieng-han-thuc-hanh-1-150k.u547.d20161001.t170135.34480.png.webp", "Ngữ pháp tiếng Hán", "104.000", "105",`Ngữ Pháp Tiếng Hán Thực Hành (Tập 1) - Trình Độ Sơ Cấp - Trung Cấp
  ...
  5) Chương V: Câu đơn
  Cuốn Ngữ pháp tiếng Hán thực hành sẽ giúp người học có cái nhìn tổng quan hơn về hệ thống Ngữ pháp tiếng Hán để người học có thể lấy đó làm cơ sở thực hành tốt các kỹ năng nghe - nói - đọc - viết và dịch được chuẩn xác.`," Ngọc Hân"),
  new InitProduct("79", "chinhtri-luatphap", "",  "./image/chinhtri-luatphap/5273c55d8d45977b9ec27244f0007da4.jpg.webp", "Cẩm nang pháp luật dành cho doanh nghiệp", "140.000", "89",`Mô tả sản phẩm: Hệ thống pháp luật trong doanh nghiệp ngày càng hoàn thiện và là cơ sở pháp lý bền vững để các doanh nghiệp trong quá trình hoạt động phải luôn luôn thực hiện đúng như quy định về điều hành, quản lý doanh nghiệp; góp vốn, đầu tư, chuyển nhượng vốn, chính sách về tiền lương, bảo hiểm; các loại thuế; sử dụng hóa đơn, kiểm tra, thanh tra các hoạt động trong doanh nghiệp …
  Để giúp bạn đọc nắm vững các nghiệp vụ theo đúng quy định, ban biên tập đã tập hợp, hoàn thiện các nội dung mới đáp ứng được mục đích tra cứu trong quá trình làm việc tại các cơ quan, doanh nghiệp.`,"The Zhishi"),
  new InitProduct("80", "chinhtri-luatphap", "",  "./image/chinhtri-luatphap/47439b4e82e4a65dd7cab7d7e6ef75a3.jpg.webp", "Bộ luật dân sự năm 2015", "122.000", "97",`Bộ luật dân sự năm 2015 được Quốc Hội nước Cộng Hòa xã hội chủ nghĩa Việt Nam khóa XIII, ký họp thứ 10 thông qua ngày 24/11/2015, có hiệu lực thi hành từ ngày 01/01/2017.
  Để triển khai thi hành Bộ Luật Dân Sự, Chính phủ đã ban hành các nghị định hướng dẫn thi hành. Nhằm cung cấp đến bạn đọc những quy định pháp luật về luật dân sự hiện hành và phục vụ tìm hiểu, thực thi pháp luật dân sự hiểu quả. Nhà Xuất Bản Chính Trị Quốc Gia Sự Thật xuất bản cuốn sách: Bộ Luật Dân Sự Năm 2015 Và Các Nghị Định Hướng Dẫn Thi Hành.`," Tăng Bình - Ái Phương"),
  new InitProduct("81", "chinhtri-luatphap", "",  "./image/chinhtri-luatphap/a3643d7af474ed84fa8821f9d5662ef8.jpg.webp", "Pháp luật về hợp đồng", "89.000", "76",`“PHÁP LUẬT VỀ HỢP ĐỒNG – CÁC VẤN ĐỀ PHÁP LÝ CƠ BẢN”
  ...
  Đây là cuốn sách duy nhất có hệ thống tra cứu đầy đủ giúp người đọc tiện tra cứu. Cuốn sách có (i) bảng tra cứu từ khóa; (ii) bảng tra cứu án lệ, bản án và quyết định; và (iii) danh sách các tài liệu trích dẫn.`," Tăng Bình - Ái Phương"),
  new InitProduct("82", "chinhtri-luatphap", "",  "./image/chinhtri-luatphap/bc86d098b7be5a20e0cd1a207ba06d5b.jpg.webp", "Bộ luật tố tụng hình sự", "118.000", "79",`Luật này đã được Quốc hội nước Cộng hoà xã hội chủ nghĩa Việt Nam thông qua tại kỳ họp thứ 10, ngày 27 tháng 11 năm 2015 và có hiệu lực thi hành từ ngày 01 tháng 7 năm 2016.
  ...
  Chương 3.  Sắt và một số kim loại quan trọng`,"PGS.TS.Nguyễn Xuân Trường"),
  new InitProduct("85", "banchay", "", "./image/banchay/6cb86fd34d89ea29a0cc8f54b45be9f3.jpg.webp", "Combo 2 sách - Khai phá hạnh phúc", "99.000", "65",`Tập sách “cứu rỗi” cho những phụ nữ đang trăn trở với câu hỏi: “Làm thế nào để đẹp và phong cách?”.
        ...
        <div class="product-tab-info ">
          ...
          <div class="product-features">
                ...
                <div class="ty-product-feature">
                    ...
                    <div class="ty-product-feature__value">17 x 23 cm</div>
                </div>
                <div class="ty-product-feature">
                    <span class="ty-product-feature__label">Số trang:</span>
                    <div class="ty-product-feature__value">359 trang</div>
                </div>
                <div class="ty-product-feature">
                    <span class="ty-product-feature__label">Tác giả:</span>
                    <div class="ty-product-feature__value">${productArr[i].author}</div>
                </div>
                <div class="ty-product-feature">
                    <span class="ty-product-feature__label">Nhà Xuất Bản:</span>
                    <div class="ty-product-feature__value">Nhà Xuất Bản Dân Trí</div>
                </div>
                <div class="ty-product-feature">
  ...
  function renderPaginationButtons() {
    ...
    if (pageCount > 1) {
      ...
      for (let i = 1; i <= pageCount; i++) {
        ...
        // style cho button trang
        paginationContainer.style.textAlign = 'center';
        paginationButton.style.padding = '8px';
        paginationButton.style.margin = '4px';
        paginationButton.style.border = '1px solid #ccc';
        paginationButton.style.backgroundColor = i === pageNumber ? '#007bff' : 'white'; // trang hiện tại
        paginationButton.style.color = i === pageNumber ? 'white' : '#007bff';
...
function getCategoryName(category) {
  switch (category) {
    ...
    case 'yhoc-suckhoe':
      return 'Sức khỏe';
    case 'kientruc-xaydung':
      return 'Kiến trúc';
    case 'kinhte':
      return 'Kinh tế';
    case 'ngoaingu':
      return 'Ngoại ngữ';
    case 'chinhtri-luatphap':
      return 'Pháp luật';
    default:
      return category;
  }
