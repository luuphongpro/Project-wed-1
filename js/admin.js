...
setInterval(function() {
    ...
    if(updateTime1<60){
        ...
        document.getElementById("innerTime1").innerHTML=`Cập nhật sau ${(updateTime1/60).toFixed()} phút trước`;
    }
    if(updateTime1/3200 >=1){
        document.getElementById("innerTime1").innerHTML=`Cập nhật sau ${(updateTime1/3200).toFixed()} giờ trước`;
    }
  }, 5000);
setInterval(function() {
// Đoạn mã hoặc hàm bạn muốn thực hiện
...
if(updateTime2<60){
    ...
    document.getElementById("innerTime2").innerHTML=`Cập nhật sau ${(updateTime2/60).toFixed()} phút trước`;
}
if(updateTime2/3200 >=1){
    document.getElementById("innerTime2").innerHTML=`Cập nhật sau ${(updateTime2/3200).toFixed()} giờ trước`;
}
}, 5000);
setInterval(function() {
    // Đoạn mã hoặc hàm bạn muốn thực hiện
    ...
    if(updateTime3<60){
        ...
        document.getElementById("innerTime3").innerHTML=`Cập nhật sau ${(updateTime3/60).toFixed()} phút trước`;
    }
    if(updateTime3/3200 >=1){
        document.getElementById("innerTime3").innerHTML=`Cập nhật sau ${(updateTime3/3200).toFixed()} giờ trước`;
    }
    }, 5000);
